...
public class SolicitacaoController {
	// pagina de solicitacao de permuta
		...
		public String showPermutaForm(Principal principal, Model model) {
			...
			// add model - solicitações já feitas
			int qSolicitacoes = listSolicitacoes.size();
			System.out.println("\nlogin controller - quantidade de solicitações: " + qSolicitacoes);
			model.addAttribute("totalSolicitacoes", qSolicitacoes);
			model.addAttribute("solicitacoesFeitas", listSolicitacoes);
